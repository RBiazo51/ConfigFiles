...
alias whatismycolor='for i in BLACK brBLACK BLUE brBLUE GREEN brGREEN YELLOW brYELLOW CYAN brCYAN WHTIE brWHITE MAGENTA brMAGENTA RED brRED NORMAL;echo (set_color $i)$i;end'
